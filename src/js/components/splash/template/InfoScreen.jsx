...
export default class SplashScreen extends React.Component {
    ...
    render() {
        ...
        let seasonsPT = ['Inverno', 'Inverno', 'Primavera', 'Primavera', 'Primavera', 'Verão', 'Verão', 'Verão', 'Inverno'];
        let weekday = ['Domingo', '2ª feira', '3ª feira', '4ª feira', '5ª feira', '6ª feira', 'Sábado'];

        let temp = !_.isEmpty(this.props.weather.items)?this.props.weather.items.main.temp:'';
        let iconCode = !_.isEmpty(this.props.weather.items)?this.props.weather.items.weather[0].description:'';
        let icon = !_.isEmpty(this.props.weather.items)?
                hour>6 && hour<20?weatherIcons[iconCode].day:weatherIcons[iconCode].night:null;
        let image = !_.isEmpty(this.props.weather.items)?weatherIcons[iconCode].backImg:null;
